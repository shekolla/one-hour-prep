...
export default function Home() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-16">
      ...
      {/* Stats bar */}
      <div className="flex flex-wrap justify-center gap-6 mb-14 text-center">
        {[
          { value: "10", label: "Topics" },
          { value: "200+", label: "Concepts" },
          { value: "70+", label: "Interview Patterns" },
          { value: "100+", label: "Common Mistakes" },
        ].map(({ value, label }) => (
          <div key={label}>
